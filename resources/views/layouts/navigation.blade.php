<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center gap-2 me-4" href="{{ route('pages.dashboard') }}">
            <span class="brand-mark"><i class="fas fa-coins"></i></span>
            Nexo Credito
        </a>
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('pages.dashboard')) active @endif" href="{{ route('pages.dashboard') }}">
                        <i class="fas fa-chart-line me-1"></i> Painel
                    </a>
                </li>
                <li class="nav-item">
